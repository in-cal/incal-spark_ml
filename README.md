# InCal Spark ML Library [![version](https://img.shields.io/badge/version-0.2.3-green.svg)](https://ada-discovery.github.io.org) [![License](https://img.shields.io/badge/License-Apache%202.0-lightgrey.svg)](https://www.apache.org/licenses/LICENSE-2.0) [![Build Status](https://travis-ci.com/peterbanda/incal-spark_ml.svg?branch=master)](https://travis-ci.com/in-cal/incal-spark_ml)
